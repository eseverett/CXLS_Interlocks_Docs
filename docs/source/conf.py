...
# ones.
extensions = ['sphinx.ext.duration', 'extensions.centered_bold_text', 'sphinxcontrib.video', 'extensions.pdf_button', 'sphinx.ext.githubpages', 'sphinx_last_updated_by_git'] ### Added extension
...
html_static_path = ['_static', 'images', 'pdfs']
html_css_files = ['custom.css', 'extensions.css'] ### Added custom css file
